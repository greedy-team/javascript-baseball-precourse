...
export function play(computerNumbers){
    ...
    let result = compareInputWithAnswer(computerNumbers, userInput);
...
function compareInputWithAnswer(computerNumbers, userInput){
    ...
    const res = result(strikeCount, ballCount);
