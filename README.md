...
[유효한 랜덤 숫자 생성 기능]
- 랜덤 숫자 3개를 생성하는 메서드
- 유효한 숫자인지 판별하는(==중복된 숫자가 아닌) 메서드

[유효한 입력값을 판별하는 기능]
- 숫자로만 이루어진 입력인지 확인하는 메서드
- 중복된 숫자가 있는 확인하는 메서드(Set 사용)

[입력값에 따른 결과 반환 기능]
- 볼(ball) 개수를 계산하는 메서드
- 스트라이크(strike) 개수를 계산하는 메서드
- 두 메서드를 사용하여 (랜덤값, 입력값)에 대한 결과를 반환하는 play 메서드

[버튼 관련 기능]
- 확인 버튼과 관련된 로직을 실행하는 메서드
- 재시작 버튼과 관련된 로직을 실행하는 메서드
- 정답을 맞췄을 때만 재시작 버튼이 보이게끔 하는 메서드
